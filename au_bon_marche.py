...
is_shopping_over = False    # Indique si les courses sont terminées
is_computer_off = False     # Indique si l'application doit être fermée
is_new_product = False      # Indique si un nouveau produit doit être ajouté
...
def is_quantity_enough(product_name, user_quantity):
    """
        ...
        while not is_shopping_over:
            ...
            while not is_new_product:
                ...
                if not is_product_exist(user_product_name):
                    ...
                    while True:
                        user_product_quantity = input("Entrez la quantité souhaitée:")
                        if user_product_quantity.isdigit():
                            user_product_quantity = int(user_product_quantity)
